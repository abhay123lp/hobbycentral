...
/**
 * Servlet implementation class ComicBooksCollectionMoreInfo
 */
public class ComicBooksCollectionMoreInfo extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ComicBooksCollectionMoreInfo() {
        super();
    ...
    protected void processData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	try {
    		String dispatchUrl = "/hobby/collecting/comicbooksmoreinfo.jsp";
