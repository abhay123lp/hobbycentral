...
/**
 * Servlet implementation class CoinCollectingMoreInfor
 */
public class CoinCollectingMoreInfo extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CoinCollectingMoreInfo() {
        super();
    ...
    protected void processData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	try {
    		String dispatchUrl = "/hobby/collecting/coincollectingmoreinfo.jsp";
