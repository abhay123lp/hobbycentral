...
/**
 * Servlet implementation class SportsCollectiblesMoreInfo
 */
public class SportsCollectiblesMoreInfo extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SportsCollectiblesMoreInfo() {
        super();
    ...
    protected void processData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	try {
    		String dispatchUrl = "/hobby/collecting/sportscollectiblesmoreinfo.jsp";
