...
/**
 * Servlet implementation class AntiqueCollectionMoreInfo
 */
public class AntiqueCollectionMoreInfo extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AntiqueCollectionMoreInfo() {
        super();
    ...
    protected void processData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	try {
    		String dispatchUrl = "/hobby/collecting/antiquesmoreinfo.jsp";
