...
/**
 * Servlet implementation class FineArtCollectionMoreInfo
 */
public class FineArtCollectionMoreInfo extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FineArtCollectionMoreInfo() {
        super();
    ...
    protected void processData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	try {
    		String dispatchUrl = "/hobby/collecting/fineartcollectingmoreinfo.jsp";
